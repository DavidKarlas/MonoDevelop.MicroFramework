	...
	class StartupHandler : CommandHandler
	{
		...
		protected override void Run()
		{
			if(Platform.IsMac)
			{
				...
				if(!Directory.Exists("/Library/Frameworks/Mono.framework/External/xbuild-frameworks/.NETMicroFramework") || !File.Exists("/Library/Frameworks/Mono.framework/External/xbuild-frameworks/.NETMicroFramework/v4.3/Microsoft.SPOT.Hardware.PWM.dll"))
				{
